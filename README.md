# App de Gestión Financiera - Módulo 1

## Estudiante: Lucia Azucena Robledo Martinez
Este proyecto es una aplicación interactiva desarrollada con *Streamlit* que cubre los fundamentos de Python aplicados al análisis financiero.
